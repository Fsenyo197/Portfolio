...
export default function Home() {
  return (
    <div className="">
      ...
      <p className="mb-4">
        Just after finishing my self-taught journey in 2022, I got an opportunity to join ALX-Africa powered by Holberton coding school in the USA. Here, we were trained on breathtaking projects as full-stack software engineers for 70 hours a week, specialiazing in Backend development. The 12-month ALX-Africa course helped me understand data structure and algorithms, database and system management, web architecture and system design, task automation, creating and consuming APIs, bug fixing, and the importance of communication and teamwork.
      </p>
      <p className="mb-4">
